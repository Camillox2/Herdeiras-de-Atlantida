# Licencas dos tiles de exploracao

## Tiny Town — Kenney

- Fonte: https://kenney.nl/assets/tiny-town
- Diretório: `assets/kenney/tiny-town/`
- Licenca: CC0 1.0 (dominio publico).
- Uso: grama, ruas, vegetacao, estruturas e objetos de Kallipolis.

## Tiny Dungeon — Kenney

- Fonte: https://kenney.nl/assets/tiny-dungeon
- Diretório: `assets/kenney/tiny-dungeon/`
- Licenca: CC0 1.0 (dominio publico).
